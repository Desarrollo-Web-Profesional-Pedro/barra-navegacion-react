/**
 * Componente MenuResponsivo - Menú desplegable para dispositivos móviles
 * Utiliza animaciones de Motion para transiciones suaves
 * @param {boolean} open - Estado que indica si el menú está abierto
